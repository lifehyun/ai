...
public class If문 {
	...
	public static void main(String[] args) {
		...
		// d !=0 이고 e가 NaN이고 f가 거짓이면 "잘못된 코드입니다" 아니면 "훌룡한 코드입니다"
		int d =10;
		double e = 10 / 0.0;
		boolean f = false;
		...
		// 변수 number가 1이면 "일" 2면 "이" 3이면 "삼" 4면 "사"라고 출력하기
		int number = 1;
		if(number == 1) {
